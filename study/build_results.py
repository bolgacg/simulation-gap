    ...
    out = {
        ...
        "statistics_only_finding": {
            ...
            "alpha_must_be_sourced_to_the_motion_statistics": "the combined distance "
                "does order drag anisotropy consistently and away from physics, but it "
                "fails the resolution bar this study set: the strongest comparison is 2.2 "
                "times its own scatter against a bar of 3, and the comparison that carries "
                "the claim, the physical value at 1.5, is only 1.3 times. Sourcing the "
